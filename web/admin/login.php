...
<div id="qo-panel">
	...
	<label id="field1-label" class="qo-abs-position" accesskey="e" for="field1"><span class="key">D</span>irección de correo</label>
	<input class="qo-abs-position" type="text" name="field1" id="field1" value="" />
	
	<label id="field2-label" class="qo-abs-position" accesskey="p" for="field2"><span class="key">C</span>ontraseña</label>
