...
QoDesk.QoAdmin.Members = Ext.extend(Ext.grid.EditorGridPanel, {
      ...
      var searchFieldBtn = new Ext.Button({
	   ...
	   Ext.applyIf(config, {
         ...
         , bbar: new Ext.PagingToolbar({
            displayInfo: true
            , displayMsg: 'Usuario {0} - {1} of {2}'
            , emptyMsg: 'Sin usuarios que mostrar'
            , pageSize: 30
            , store: store
         })
         , closable: true
         ...
         , title: 'Usuarios'
	      , viewConfig: {
	         emptyText: 'Sin usuarios que mostrar...'
            //, ignoreAdd: true
   ...
   , deleteMember : function(record){
      Ext.MessageBox.confirm('Confirm', 'Está seguro de borrar el usuario: ' + record.data.id + '?', function(btn){
         if(btn === "yes"){
